...
const ShopLogin = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`${BASE_URL}/api/v1/shop/login`, shopData, {
            ...
            .catch((err) => {
                console.log("somthing went wrong at login shop", err);
                ...
                <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                    <form className='space-y-6' onSubmit={handleSubmit}>
                        ...
                        <div className={`${styles.noramlFlex} w-full`}>
                            ...
                            <Link to={"/seller-create"} className='text-blue-600 pl-2'>Create Shop</Link>
                        </div>
                    </form>
                </div>
            </div>
